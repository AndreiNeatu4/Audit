 ...
 *                                                └─▶ EN 301 549 clause 9 (web) == WCAG 2.1 Level AA
 *
 * So for a web page, "does it follow the EU directive?" means:
 *   "does it meet every WCAG 2.1 Level A + AA success criterion?"
 *
...
const RAW = [
  ...
  // ── Principle 4: Robust ─────────────────────────────────────────────────
  { num: '4.1.1',  level: 'A',  name: 'Parsing',                                   check: 'Markup is well-formed (no duplicate IDs, valid nesting).' },
...
const DIRECTIVE = {
  ...
  harmonisedStandard: 'EN 301 549 (clause 9) → WCAG 2.1 Level A + AA',
  conformityBasis:
